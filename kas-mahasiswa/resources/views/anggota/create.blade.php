...
<div class="card shadow">
    <div class="card-body">
        <h4 class="mb-4">Tambah Anggota & Akun Login</h4>
        ...
        <form action="{{ route('anggota.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="contoh: pengurus@gmail.com" required>
                    @error('email') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="col-md-6 mb-3">
                    <label class="form-label">Password Login</label>
                    <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Masukkan password awal" required>
            ...
            <div class="alert alert-info">
                Akun login akan otomatis dibuat dengan role <strong>Pengurus</strong>.
            </div>
